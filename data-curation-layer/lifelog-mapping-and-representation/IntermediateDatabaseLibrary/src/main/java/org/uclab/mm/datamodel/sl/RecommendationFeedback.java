...
public class RecommendationFeedback implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof RecommendationFeedback)) {
            return false;
        }
        RecommendationFeedback other = (RecommendationFeedback) object;
    ...
    public String toString() {
        return "org.uclab.mm.datamodel.sl.RecommendationFeedback[ id=" + id + " ]";
    }

    /**
     * @return the recommendationFeedbackID
     */
    public Long getRecommendationFeedbackID() {
        return recommendationFeedbackID;
    }

    /**
     * @param recommendationFeedbackID the recommendationFeedbackID to set
     */
    public void setRecommendationFeedbackID(Long recommendationFeedbackID) {
        this.recommendationFeedbackID = recommendationFeedbackID;
    }
