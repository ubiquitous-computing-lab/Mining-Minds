...
/**
 * This interface is to provide the specification for store and retrieve methods.
 * @author Rizvi
 */
public interface SituationEventDAO{
 /**
  * The method specification for persistently storage of situation provided by experts.
  * @param objSituationEvents 
  */
  public void persistentSituation(SituationEvents objSituationEvents);
/**
 * The method specification for retrieval of situation details provided by experts.
 * @return 
 */
