...
/**
 * The abstract class for notification management services are defined to give flexibility
 * for communication way.
 * @author Rizvi
 */
public abstract class NotifyService{
  ...
  /**
   * Constructor for NotifyService class which initialize the communication channel
...
/**
 * The abstract method used to send notification.
 */
