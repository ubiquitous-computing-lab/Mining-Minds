...
public class TestHLCA {
	...
	static final String ontologyFile = "file:////E:/ICL_LOG/TDB/context-v3.owl"; //    context-v3-0  context-v2-5  
	...
	public static void main(String[] args) {
		 ...
		 if(mng.correctInitialization()) {
			...
			Calendar windowStart = util.parseString("2016 04 18 10:10:01");
