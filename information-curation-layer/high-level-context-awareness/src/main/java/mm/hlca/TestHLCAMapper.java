...
public class TestHLCAMapper {
	...
	static final String ontologyFile = "file:////E:/ICL_LOG/TDB/context-v3.owl";   //context-v2-5   context-v3-0             
	static final String llcLabel = "HypertensionStageII";   //NormalBG     
	...
	public static void main(String[] args) {
		...
		if (mng.correctInitialization()) {
			ContextMapper mapper = new ContextMapper(mng.getContextOntology());
			  Calendar cal = util.parseString("2016 04 18 10:11:59");           
