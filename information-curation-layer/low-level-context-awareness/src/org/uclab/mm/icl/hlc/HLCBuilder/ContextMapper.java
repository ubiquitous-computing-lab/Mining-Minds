 ...
 * 
 * @author Muhammad Asif Razzaq and Claudia Villalonga
 * @version 2.0
 * @since 2015-11-12
 */
...
//Asif Added
		...
		// Testing
//		ContextHandler.finalizePreviousLlc(ont.getLlcCategoryClass(HLCA.seafoodClassName), user, time);
		// Testing
