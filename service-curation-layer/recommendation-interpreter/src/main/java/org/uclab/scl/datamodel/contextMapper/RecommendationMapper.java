...
public class RecommendationMapper {
  ...
  private static final String recommendationPath = "RecommendationMapper.txt";
  private static Scanner scanFile;

  public RecommendationMapper() {
    try {
      scanFile = new Scanner(this.getClass().getClassLoader().getResourceAsStream(recommendationPath));
    } catch (Exception exp) {
      LOG.debug(exp.getMessage());
    }
  }
  public HashMap recMapper() throws FileNotFoundException {
