...
public class UserChoiceMapper {
  static HashMap<String, String> mapUserChoices = new HashMap<>();
  private static final String filePath = "UserChoices.txt";
  private static Scanner scanFile;

  public HashMap UserChoicesMapper() throws FileNotFoundException {
    try {
