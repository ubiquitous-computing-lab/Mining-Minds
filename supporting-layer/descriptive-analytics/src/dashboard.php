                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-4 col-sm-6">
                            <div class="col-md-12 main-btn btn btn-primary">
                                    
									
									<span class="style1"> <a href="dashboard.php">DashBoard</a></span>                            </div>
                      </div>
						
						
						<div class="col-lg-4 col-sm-6">
                            <div class="col-md-12 main-btn btn btn-primary btn-outline ">
                                    <span class="info_box_icon icon_group"></span>
                                        <span> <span class="style1"><a href="users.html">Users</a></span></span>                            </div>
                      </div>
						
						
<div class="col-lg-4 col-sm-6">
                            <div class="col-md-12 main-btn btn btn-primary btn-outline  style1"><a href="query.html"> 							 Query Panel                            </a></div>
                      </div>
