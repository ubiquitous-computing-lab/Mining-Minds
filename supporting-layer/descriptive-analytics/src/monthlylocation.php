...
class monthlylocation{
	...
	public function monthlylocationJS() {	
	
	
	
					
				$uid=$_GET['userid'];
				$locationdata=$this->calculatemonthlylocation(29,$uid);			
...
public function calculatemonthlylocation($days,$uid){
