                ...
                <div class="timeline-row">
                  ...
                  <div class="timeline-content">
                    ...
                    <div class="timeline-inner-content">
							...
							$recTimeline = new Recommendation();
							$recTimeline->timeline();
							
							
					//	include "dynamictimeline.php"; 
...
-->                 <li><a data-toggle="tab" role="tab" href="#HLC">High Level Context</a> </li>
            ...
            <div id="activity" class="tab-pane fade in active">
             ...
             <!-- tabcontent div end-->
              ...
              <div id="nutrition_graphs"><h2> Nutrition Graphs</h2>
                ...
                <li><a data-toggle="tab" role="tab" href="#bntrends">Basic Nutrient Trends</a></li>
     ...
     <div id="bntrends" class="tab-pane fade"> <h2>User Nutrient Consumption Trend</h2>
...
<?php 
	...
	include "recfeedback.php";
	
	$fbackObject = new Feedback('feedback');
	$fbackObject->feedbackJS();
	
	
	include "nutrition.php";
	$nutritionObject = new nutrition('nutrition');
	$nutritionObject->nutritionJS();

	
	include "dailyactivity.php";
	$dailyactivityObject = new dailyactivity('dailyactivity');
	$dailyactivityObject->dailyactivityJS();
	
	
	
	include "weeklyactivity.php";
	$weeklyactivityObject = new weeklyactivity('weeklyactivity');
	$weeklyactivityObject->weeklyactivityJS();
...
//echo "the total elapsed time is ".$time_elapsed_secs;
//exit;
