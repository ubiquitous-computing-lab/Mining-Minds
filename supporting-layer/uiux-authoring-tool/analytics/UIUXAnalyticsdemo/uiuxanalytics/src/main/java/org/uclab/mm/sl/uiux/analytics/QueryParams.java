...
public enum QueryParams {
     ...
     */
    TOTAL_NUMBER_OF_VISITS("total_number_of_visit"),
    /**
     ...
     */
    PREVIOUS_VISIT_TIMESTAMP("prevoius_visit_timestamp"),
    /**
     ...
     * To access this value, users must be logged-in in your system so you can fetch this user ID from your system, and pass it to UIUXAnalytics.
     ...
     */
    DATETIME_OF_REQUEST("visit_time"),
    ...
    // Other parameters
    /**
     * If set to 0 (send_image=0) UIUXAnalytics will respond with a HTTP 204 response code instead of a GIF image.<p>
     * This improves performance and can fix errors if images are not allowed to be obtained directly (eg Chrome Apps). Available since UIUXAnalytics 2.10.0
     */
